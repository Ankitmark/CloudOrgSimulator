...
object Simulation2a:
  ...
  val logger = LoggerFactory.getLogger("simulation2a")
  ...
  // Creating DataCenter
  val dataCenterSimple = SimulationUtil.create_DataCenter("simulation2a", new VmAllocationPolicyRoundRobin)
  ...
  logger.info("Simulation2a starting")
  ...
  logger.info("-----Cost for simulation2a is-----:  " + SimulationUtil.cost(dataCenterSimple, cloudletList).toString)
