...
object Simulation2b:
  ...
  // Creating DataCenter
  val dataCenterSimple = SimulationUtil.create_DataCenter("simulation2b", new VmAllocationPolicyRoundRobin)
  ...
  logger.info("Simulation2b starting")
  ...
  logger.info("-----Cost for simulation2b is-----: " + SimulationUtil.cost(dataCenterSimple, cloudletList).toString)
